...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="#" class="nav-link tooltip-custom" data-tooltip="Cuestionarios">
    ...
    <div class="main-content" id="mainContent">
        ...
        <main class="container mt-5">
            <h1>Deja tu comentario para un psicólogo</h1>
            ...
            <div class="alert alert-info shadow-sm" style="font-size:1.15rem; background:rgba(45,137,239,0.08); border-left:5px solid var(--primary-color); color:var(--primary-color); border-radius:18px; margin-bottom:0.1rem !important;">
                ...
                Este espacio está hecho para que compartas tus inquietudes con nuestros profesionales. El psicólogo que elijas te dará respuesta lo más pronto posible.
            </div>

            <?php if ($mensaje_exito): ?>
                <div class="alert <?php echo strpos($mensaje_exito, 'Error') !== false ? 'alert-danger' : 'alert-success'; ?>">
                    <?php echo $mensaje_exito; ?>
                </div>
            <?php endif; ?>

            <div class="card mt-0">
                <h2><i class="fas fa-comments"></i>Enviar Comentario</h2>
                <form method="POST" action="">
                    <div class="mb-3">
                        ...
                        <select name="psicologo_id" id="psicologo_id" class="form-select" required>
                            ...
                            <?php foreach ($psicologos as $psicologo): ?>
                                <option value="<?php echo $psicologo['id']; ?>" <?php if (isset($_POST['psicologo_id']) && $_POST['psicologo_id'] == $psicologo['id']) echo 'selected'; ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="comentario" id="comentario" rows="4" class="form-control" required><?php echo isset($_POST['comentario']) ? htmlspecialchars($_POST['comentario']) : ''; ?></textarea>
                        <?php if ($comentarioErr): ?>
